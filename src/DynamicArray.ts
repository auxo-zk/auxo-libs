...
export function Bit255DynamicArray(maxLength: number) {
  if (maxLength > 128) throw new Error('Exceed maximum size');
  return DynamicArray(Bit255, maxLength);
}

export function BoolDynamicArray(maxLength: number) {
  if (maxLength > 256) throw new Error('Exceed maximum size');
  return DynamicArray(Bool, maxLength);
}

export function FieldDynamicArray(maxLength: number) {
  if (maxLength > 256) throw new Error('Exceed maximum size');
  return DynamicArray(Field, maxLength);
}

export function GroupDynamicArray(maxLength: number) {
  if (maxLength > 128) throw new Error('Exceed maximum size');
  return DynamicArray(Group, maxLength);
}

export function ScalarDynamicArray(maxLength: number) {
  if (maxLength > 128) throw new Error('Exceed maximum size');
  return DynamicArray(CustomScalar, maxLength);
}

export function PublicKeyDynamicArray(maxLength: number) {
  if (maxLength > 128) throw new Error('Exceed maximum size');
